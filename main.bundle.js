...
var _genreData = __webpack_require__(/*! ./genre-data.json */ "./src/model/genre-data.json");
  ...
  _createClass(Model, [{
    ...
    value: function getNewData() {
      ...
      return fetch('https://cors-anywhere.herokuapp.com/' + this.url).then(function (res) {
        ...
        localStorage.setItem('genres', _this.data);
        return _this.data;
      });
    }
  }, {
    ...
    value: function convertToModel(el) {
      var nodeList = el.querySelectorAll('.articleBody p');

      var genres = [];

      nodeList.forEach(function (node) {
        // account for two genres in same <p> tag
        var separatedGenres = node.textContent.split(/\n/);
